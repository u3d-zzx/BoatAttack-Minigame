...
namespace WaterSystem
{
    ...
    public class Water : MonoBehaviour
    {
        ...
        public void Init()
        {
            SetWaves();
            GenerateColorRamp();
            //if (SceneManager.GetActiveScene().name == "main_menu"|| SceneManager.GetActiveScene().name == "main_menu_simple")
            //{ bakedDepthTex = Resources.Load("main_menu_simple") as Texture2D;
            //    //Debug.LogError("main_menu");
            //}
            //else
            {
               // bakedDepthTex = Resources.Load(SceneManager.GetActiveScene().name) as Texture2D;
            }
            ...
            {
                Debug.LogError("Water Depth Texture is not ready. " + SceneManager.GetActiveScene().name);
            }
            ...
            if (Application.platform != RuntimePlatform.WebGLPlayer && Application.platform != RuntimePlatform.WeixinMiniGamePlayer) // TODO - bug with Opengl depth
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // TODO Dynamic Depth Map closed, using baked depthmap instade.
//#if false
