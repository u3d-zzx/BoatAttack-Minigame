...
namespace WaterSystem
{
    ...
    public class WaterEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            /*var waterResource = serializedObject.FindProperty("resources");
            EditorGUILayout.PropertyField(waterResource, true);
            if (waterResource.objectReferenceValue != null)
            {
                CreateEditor((WaterResources)waterResource.objectReferenceValue).OnInspectorGUI();
            }*/
            //var waterDepthTexture = serializedObject.FindProperty("bakedDepthTex");
            //EditorGUILayout.PropertyField(waterDepthTexture, true);
